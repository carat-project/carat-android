...
public class Questionnaire implements org.apache.thrift.TBase<Questionnaire, Questionnaire._Fields>, java.io.Serializable, Cloneable, Comparable<Questionnaire> {
  ...
  private static final org.apache.thrift.protocol.TField REPEAT_FIELD_DESC = new org.apache.thrift.protocol.TField("repeat", org.apache.thrift.protocol.TType.BOOL, (short)5);
  private static final org.apache.thrift.protocol.TField REPEAT_INTERVAL_FIELD_DESC = new org.apache.thrift.protocol.TField("repeatInterval", org.apache.thrift.protocol.TType.I64, (short)6);
  private static final org.apache.thrift.protocol.TField REPEAT_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("repeatCount", org.apache.thrift.protocol.TType.I64, (short)7);
  private static final org.apache.thrift.protocol.TField REPEAT_DAYS_FIELD_DESC = new org.apache.thrift.protocol.TField("repeatDays", org.apache.thrift.protocol.TType.I64, (short)8);
  private static final org.apache.thrift.protocol.TField ACTION_TITLE_FIELD_DESC = new org.apache.thrift.protocol.TField("actionTitle", org.apache.thrift.protocol.TType.STRING, (short)9);
  private static final org.apache.thrift.protocol.TField ACTION_TEXT_FIELD_DESC = new org.apache.thrift.protocol.TField("actionText", org.apache.thrift.protocol.TType.STRING, (short)10);
  ...
  public long repeatInterval; // optional
  public long repeatCount; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    REPEAT((short)5, "repeat"),
    REPEAT_INTERVAL((short)6, "repeatInterval"),
    REPEAT_COUNT((short)7, "repeatCount"),
    REPEAT_DAYS((short)8, "repeatDays"),
    ACTION_TITLE((short)9, "actionTitle"),
    ACTION_TEXT((short)10, "actionText"),
  ...
  private static final int __REPEATINTERVAL_ISSET_ID = 4;
  private static final int __REPEATCOUNT_ISSET_ID = 5;
  private static final int __REPEATDAYS_ISSET_ID = 6;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.PREREQUISITES,_Fields.COOLDOWN,_Fields.EXPIRATION_DATE,_Fields.REPEAT,_Fields.REPEAT_INTERVAL,_Fields.REPEAT_COUNT,_Fields.REPEAT_DAYS,_Fields.ACTION_TITLE,_Fields.ACTION_TEXT};
  ...
  public Questionnaire setRepeatInterval(long repeatInterval) {
  ...
  public Questionnaire setRepeatCount(long repeatCount) {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case REPEAT_INTERVAL:
      return Long.valueOf(getRepeatInterval());

    case REPEAT_COUNT:
      return Long.valueOf(getRepeatCount());
  ...
  public int hashCode() {
    ...
    boolean present_repeatInterval = true && (isSetRepeatInterval());
    list.add(present_repeatInterval);
    if (present_repeatInterval)
      list.add(repeatInterval);

    boolean present_repeatCount = true && (isSetRepeatCount());
    list.add(present_repeatCount);
    if (present_repeatCount)
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Questionnaire struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.prerequisites = new ArrayList<Integer>(_list104.size);
                int _elem105;
                for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                {
                  _elem105 = iprot.readI32();
                  struct.prerequisites.add(_elem105);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // REPEAT_INTERVAL
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.repeatInterval = iprot.readI64();
          ...
          case 7: // REPEAT_COUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.repeatCount = iprot.readI64();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.items = new ArrayList<QuestionnaireItem>(_list107.size);
                QuestionnaireItem _elem108;
                for (int _i109 = 0; _i109 < _list107.size; ++_i109)
                {
                  _elem108 = new QuestionnaireItem();
                  _elem108.read(iprot);
                  struct.items.add(_elem108);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Questionnaire struct) throws org.apache.thrift.TException {
      ...
      if (struct.prerequisites != null) {
        if (struct.isSetPrerequisites()) {
          oprot.writeFieldBegin(PREREQUISITES_FIELD_DESC);
          {
            ...
            for (int _iter110 : struct.prerequisites)
            {
      ...
      if (struct.items != null) {
        oprot.writeFieldBegin(ITEMS_FIELD_DESC);
        {
          ...
          for (QuestionnaireItem _iter111 : struct.items)
          {
  ...
  private static class QuestionnaireTupleScheme extends TupleScheme<Questionnaire> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Questionnaire struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.id);
      {
        ...
        for (QuestionnaireItem _iter112 : struct.items)
        {
      ...
      if (struct.isSetPrerequisites()) {
        {
          ...
          for (int _iter113 : struct.prerequisites)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Questionnaire struct) throws org.apache.thrift.TException {
      ...
      struct.setIdIsSet(true);
      {
        ...
        struct.items = new ArrayList<QuestionnaireItem>(_list114.size);
        QuestionnaireItem _elem115;
        for (int _i116 = 0; _i116 < _list114.size; ++_i116)
        {
          _elem115 = new QuestionnaireItem();
          _elem115.read(iprot);
          struct.items.add(_elem115);
        }
      }
      struct.setItemsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.prerequisites = new ArrayList<Integer>(_list117.size);
          int _elem118;
          for (int _i119 = 0; _i119 < _list117.size; ++_i119)
          {
            _elem118 = iprot.readI32();
            struct.prerequisites.add(_elem118);
          }
        }
        struct.setPrerequisitesIsSet(true);
      }
