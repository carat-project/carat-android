...
public class Activity implements org.apache.thrift.TBase<Activity, Activity._Fields>, java.io.Serializable, Cloneable, Comparable<Activity> {
  ...
  public Activity setProcessName(String processName) {
  ...
  public Activity setForegroundTime(double foregroundTime) {
  ...
  public Activity setLaunchCount(double launchCount) {
