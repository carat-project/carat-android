...
public class RunningService implements org.apache.thrift.TBase<RunningService, RunningService._Fields>, java.io.Serializable, Cloneable, Comparable<RunningService> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RunningService");
  ...
  static {
    schemes.put(StandardScheme.class, new RunningServiceStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RunningServiceTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RunningService.class, metaDataMap);
  }
  ...
  public RunningService deepCopy() {
    return new RunningService(this);
  }
  ...
  public RunningService setProcessName(String processName) {
  ...
  public RunningService setPId(int pId) {
    this.pId = pId;
    setPIdIsSet(true);
    return this;
  }
  ...
  public RunningService setSleeping(boolean sleeping) {
  ...
  public RunningService setForeground(boolean foreground) {
  ...
  public RunningService setUId(int uId) {
    this.uId = uId;
    setUIdIsSet(true);
    return this;
  }
  ...
  public RunningService setCrashCount(int crashCount) {
  ...
  public RunningService setLastActivityTime(double lastActivityTime) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RunningService)
      return this.equals((RunningService)that);
    return false;
  }

  public boolean equals(RunningService that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RunningService other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RunningService(");
    boolean first = true;
  ...
  private static class RunningServiceStandardSchemeFactory implements SchemeFactory {
    public RunningServiceStandardScheme getScheme() {
      return new RunningServiceStandardScheme();
    }
  }

  private static class RunningServiceStandardScheme extends StandardScheme<RunningService> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RunningService struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RunningService struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RunningServiceTupleSchemeFactory implements SchemeFactory {
    public RunningServiceTupleScheme getScheme() {
      return new RunningServiceTupleScheme();
    }
  }

  private static class RunningServiceTupleScheme extends TupleScheme<RunningService> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RunningService struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RunningService struct) throws org.apache.thrift.TException {
