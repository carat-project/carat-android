...
public class QuestionnaireItem implements org.apache.thrift.TBase<QuestionnaireItem, QuestionnaireItem._Fields>, java.io.Serializable, Cloneable, Comparable<QuestionnaireItem> {
  ...
  private static final org.apache.thrift.protocol.TField OTHER_NUMERIC_FIELD_DESC = new org.apache.thrift.protocol.TField("otherNumeric", org.apache.thrift.protocol.TType.BOOL, (short)7);
  ...
  public boolean otherNumeric; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    OTHER_NUMERIC((short)7, "otherNumeric");
  ...
  private static final int __OTHERNUMERIC_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.QUESTION_ID,_Fields.TITLE,_Fields.CONTENT,_Fields.CHOICES,_Fields.OTHER_OPTION,_Fields.OTHER_NUMERIC};
  ...
  static {
    ...
    tmpMap.put(_Fields.OTHER_NUMERIC, new org.apache.thrift.meta_data.FieldMetaData("otherNumeric", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public QuestionnaireItem(QuestionnaireItem other) {
    ...
    this.otherNumeric = other.otherNumeric;
  }
  ...
  public void clear() {
    ...
    setOtherNumericIsSet(false);
    this.otherNumeric = false;
  }
  ...
  public boolean isOtherNumeric() {
    return this.otherNumeric;
  }

  public QuestionnaireItem setOtherNumeric(boolean otherNumeric) {
    this.otherNumeric = otherNumeric;
    setOtherNumericIsSet(true);
    return this;
  }

  public void unsetOtherNumeric() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __OTHERNUMERIC_ISSET_ID);
  }

  /** Returns true if field otherNumeric is set (has been assigned a value) and false otherwise */
  public boolean isSetOtherNumeric() {
    return EncodingUtils.testBit(__isset_bitfield, __OTHERNUMERIC_ISSET_ID);
  }

  public void setOtherNumericIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __OTHERNUMERIC_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case OTHER_NUMERIC:
      return Boolean.valueOf(isOtherNumeric());
  ...
  public boolean equals(QuestionnaireItem that) {
    ...
    boolean this_present_otherNumeric = true && this.isSetOtherNumeric();
    boolean that_present_otherNumeric = true && that.isSetOtherNumeric();
    if (this_present_otherNumeric || that_present_otherNumeric) {
      if (!(this_present_otherNumeric && that_present_otherNumeric))
        return false;
      if (this.otherNumeric != that.otherNumeric)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_otherNumeric = true && (isSetOtherNumeric());
    list.add(present_otherNumeric);
    if (present_otherNumeric)
      list.add(otherNumeric);
  ...
  public int compareTo(QuestionnaireItem other) {
    ...
    lastComparison = Boolean.valueOf(isSetOtherNumeric()).compareTo(other.isSetOtherNumeric());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOtherNumeric()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.otherNumeric, other.otherNumeric);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetOtherNumeric()) {
      if (!first) sb.append(", ");
      sb.append("otherNumeric:");
      sb.append(this.otherNumeric);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class QuestionnaireItemStandardScheme extends StandardScheme<QuestionnaireItem> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, QuestionnaireItem struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // OTHER_NUMERIC
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.otherNumeric = iprot.readBool();
              struct.setOtherNumericIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QuestionnaireItem struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOtherNumeric()) {
        oprot.writeFieldBegin(OTHER_NUMERIC_FIELD_DESC);
        oprot.writeBool(struct.otherNumeric);
        oprot.writeFieldEnd();
      }
