...
public class QuestionnaireItem implements org.apache.thrift.TBase<QuestionnaireItem, QuestionnaireItem._Fields>, java.io.Serializable, Cloneable, Comparable<QuestionnaireItem> {
  ...
  private static final org.apache.thrift.protocol.TField OTHER_FIELD_DESC = new org.apache.thrift.protocol.TField("other", org.apache.thrift.protocol.TType.BOOL, (short)6);
  private static final org.apache.thrift.protocol.TField NUMERIC_FIELD_DESC = new org.apache.thrift.protocol.TField("numeric", org.apache.thrift.protocol.TType.BOOL, (short)7);
  ...
  private static final int __NUMERIC_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.QUESTION_ID,_Fields.TITLE,_Fields.CONTENT,_Fields.CHOICES,_Fields.OTHER,_Fields.NUMERIC};
  ...
  static {
    ...
    tmpMap.put(_Fields.NUMERIC, new org.apache.thrift.meta_data.FieldMetaData("numeric", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
   ...
   * @see ItemType
   */
  public QuestionnaireItem setType(ItemType type) {
    this.type = type;
    return this;
  }
  ...
  public QuestionnaireItem setOther(boolean other) {
    this.other = other;
    setOtherIsSet(true);
    return this;
  }
  ...
  public QuestionnaireItem setNumeric(boolean numeric) {
    this.numeric = numeric;
    setNumericIsSet(true);
    return this;
  }

  public void unsetNumeric() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUMERIC_ISSET_ID);
  }

  /** Returns true if field numeric is set (has been assigned a value) and false otherwise */
  public boolean isSetNumeric() {
    return EncodingUtils.testBit(__isset_bitfield, __NUMERIC_ISSET_ID);
  }

  public void setNumericIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUMERIC_ISSET_ID, value);
  }
  ...
  public boolean equals(QuestionnaireItem that) {
    ...
    boolean this_present_numeric = true && this.isSetNumeric();
    boolean that_present_numeric = true && that.isSetNumeric();
    if (this_present_numeric || that_present_numeric) {
      if (!(this_present_numeric && that_present_numeric))
        return false;
  ...
  public int hashCode() {
    ...
    boolean present_numeric = true && (isSetNumeric());
    list.add(present_numeric);
    if (present_numeric)
      list.add(numeric);
  ...
  public int compareTo(QuestionnaireItem other) {
    ...
    lastComparison = Boolean.valueOf(isSetNumeric()).compareTo(other.isSetNumeric());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumeric()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numeric, other.numeric);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class QuestionnaireItemStandardScheme extends StandardScheme<QuestionnaireItem> {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = edu.berkeley.cs.amplab.carat.thrift.ItemType.findByValue(iprot.readI32());
          ...
          case 7: // NUMERIC
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.numeric = iprot.readBool();
              struct.setNumericIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QuestionnaireItem struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetNumeric()) {
        oprot.writeFieldBegin(NUMERIC_FIELD_DESC);
        oprot.writeBool(struct.numeric);
        oprot.writeFieldEnd();
      }
