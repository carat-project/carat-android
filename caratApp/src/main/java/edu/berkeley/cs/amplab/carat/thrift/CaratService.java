...
public class CaratService {
  ...
  public interface Iface {
    ...
    public List<QuestionItem> getQuestionnaire(String uuId) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<QuestionItem> recv_getQuestionnaire() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getQuestionnaire_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<QuestionItem> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getQuestionnaire<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getQuestionnaire_args, List<QuestionItem>> {
      public getQuestionnaire() {
        super("getQuestionnaire");
      }
      ...
      public AsyncMethodCallback<List<QuestionItem>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<QuestionItem>>() { 
          public void onComplete(List<QuestionItem> o) {
            getQuestionnaire_result result = new getQuestionnaire_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getQuestionnaire_args args, org.apache.thrift.async.AsyncMethodCallback<List<QuestionItem>> resultHandler) throws TException {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.processList = new ArrayList<String>(_list112.size);
                  String _elem113;
                  for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                  {
                    _elem113 = iprot.readString();
                    struct.processList.add(_elem113);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getQuickHogsAndMaybeRegister_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.processList != null) {
          oprot.writeFieldBegin(PROCESS_LIST_FIELD_DESC);
          {
            ...
            for (String _iter115 : struct.processList)
            {
        ...
        if (struct.isSetProcessList()) {
          {
            ...
            for (String _iter116 : struct.processList)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.processList = new ArrayList<String>(_list117.size);
            String _elem118;
            for (int _i119 = 0; _i119 < _list117.size; ++_i119)
            {
              _elem118 = iprot.readString();
              struct.processList.add(_elem118);
            }
          }
          struct.setProcessListIsSet(true);
        }
  ...
  public static class getQuestionnaire_result implements org.apache.thrift.TBase<getQuestionnaire_result, getQuestionnaire_result._Fields>, java.io.Serializable, Cloneable, Comparable<getQuestionnaire_result>   {
    ...
    public List<QuestionItem> success; // required
    ...
    public java.util.Iterator<QuestionItem> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(QuestionItem elem) {
      if (this.success == null) {
        this.success = new ArrayList<QuestionItem>();
      }
      this.success.add(elem);
    }

    public List<QuestionItem> getSuccess() {
      return this.success;
    }

    public getQuestionnaire_result setSuccess(List<QuestionItem> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<QuestionItem>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<QuestionItem>(_list120.size);
                  QuestionItem _elem121;
                  for (int _i122 = 0; _i122 < _list120.size; ++_i122)
                  {
                    _elem121 = new QuestionItem();
                    _elem121.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getQuestionnaire_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (QuestionItem _iter123 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (QuestionItem _iter124 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<QuestionItem>(_list125.size);
            QuestionItem _elem126;
            for (int _i127 = 0; _i127 < _list125.size; ++_i127)
            {
              _elem126 = new QuestionItem();
              _elem126.read(iprot);
