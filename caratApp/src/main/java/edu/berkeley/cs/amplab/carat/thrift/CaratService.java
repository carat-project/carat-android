...
public class CaratService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<QuestionnaireItem> recv_getQuestionnaire() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getQuestionnaire_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<QuestionnaireItem> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getQuestionnaire<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getQuestionnaire_args, List<QuestionnaireItem>> {
      public getQuestionnaire() {
        super("getQuestionnaire");
      }
      ...
      public AsyncMethodCallback<List<QuestionnaireItem>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<QuestionnaireItem>>() { 
          public void onComplete(List<QuestionnaireItem> o) {
            getQuestionnaire_result result = new getQuestionnaire_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getQuestionnaire_args args, org.apache.thrift.async.AsyncMethodCallback<List<QuestionnaireItem>> resultHandler) throws TException {
  ...
  public static class getQuestionnaire_result implements org.apache.thrift.TBase<getQuestionnaire_result, getQuestionnaire_result._Fields>, java.io.Serializable, Cloneable, Comparable<getQuestionnaire_result>   {
    ...
    public List<QuestionnaireItem> success; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.LIST          , "Questionnaire")));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getQuestionnaire_result(
      List<QuestionnaireItem> success)
    {
      this();
      this.success = success;
    }
    ...
    public java.util.Iterator<QuestionnaireItem> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(QuestionnaireItem elem) {
      if (this.success == null) {
        this.success = new ArrayList<QuestionnaireItem>();
      }
      this.success.add(elem);
    }

    public List<QuestionnaireItem> getSuccess() {
      return this.success;
    }

    public getQuestionnaire_result setSuccess(List<QuestionnaireItem> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<QuestionnaireItem>)value);
        }
        break;
