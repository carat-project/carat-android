              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.features = new ArrayList<Feature>(_list136.size);
                  Feature _elem137;
                  for (int _i138 = 0; _i138 < _list136.size; ++_i138)
                  {
                    _elem137 = new Feature();
                    _elem137.read(iprot);
                    struct.features.add(_elem137);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getReports_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.features != null) {
          oprot.writeFieldBegin(FEATURES_FIELD_DESC);
          {
            ...
            for (Feature _iter139 : struct.features)
            {
        ...
        if (struct.isSetFeatures()) {
          {
            ...
            for (Feature _iter140 : struct.features)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.features = new ArrayList<Feature>(_list141.size);
            Feature _elem142;
            for (int _i143 = 0; _i143 < _list141.size; ++_i143)
            {
              _elem142 = new Feature();
              _elem142.read(iprot);
              struct.features.add(_elem142);
            }
          }
          struct.setFeaturesIsSet(true);
        }
    ...
    private static class getHogOrBugReport_argsStandardScheme extends StandardScheme<getHogOrBugReport_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.features = new ArrayList<Feature>(_list144.size);
                  Feature _elem145;
                  for (int _i146 = 0; _i146 < _list144.size; ++_i146)
                  {
                    _elem145 = new Feature();
                    _elem145.read(iprot);
                    struct.features.add(_elem145);
                  }
                  iprot.readListEnd();
                }
                struct.setFeaturesIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getHogOrBugReport_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.features != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.features.size()));
            for (Feature _iter147 : struct.features)
            {
    ...
    private static class getHogOrBugReport_argsTupleScheme extends TupleScheme<getHogOrBugReport_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getHogOrBugReport_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetFeatures()) {
          {
            oprot.writeI32(struct.features.size());
            for (Feature _iter148 : struct.features)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.features = new ArrayList<Feature>(_list149.size);
            Feature _elem150;
            for (int _i151 = 0; _i151 < _list149.size; ++_i151)
            {
              _elem150 = new Feature();
              _elem150.read(iprot);
              struct.features.add(_elem150);
            }
          }
          struct.setFeaturesIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.processList = new ArrayList<String>(_list152.size);
                  String _elem153;
                  for (int _i154 = 0; _i154 < _list152.size; ++_i154)
                  {
                    _elem153 = iprot.readString();
                    struct.processList.add(_elem153);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getQuickHogsAndMaybeRegister_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.processList != null) {
          oprot.writeFieldBegin(PROCESS_LIST_FIELD_DESC);
          {
            ...
            for (String _iter155 : struct.processList)
            {
        ...
        if (struct.isSetProcessList()) {
          {
            ...
            for (String _iter156 : struct.processList)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.processList = new ArrayList<String>(_list157.size);
            String _elem158;
            for (int _i159 = 0; _i159 < _list157.size; ++_i159)
            {
              _elem158 = iprot.readString();
              struct.processList.add(_elem158);
            }
          }
          struct.setProcessListIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Questionnaire>(_list160.size);
                  Questionnaire _elem161;
                  for (int _i162 = 0; _i162 < _list160.size; ++_i162)
                  {
                    _elem161 = new Questionnaire();
                    _elem161.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getQuestionnaires_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Questionnaire _iter163 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Questionnaire _iter164 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Questionnaire>(_list165.size);
            Questionnaire _elem166;
            for (int _i167 = 0; _i167 < _list165.size; ++_i167)
            {
              _elem166 = new Questionnaire();
              _elem166.read(iprot);
