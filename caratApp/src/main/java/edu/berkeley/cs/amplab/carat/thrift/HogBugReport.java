...
public class HogBugReport implements org.apache.thrift.TBase<HogBugReport, HogBugReport._Fields>, java.io.Serializable, Cloneable, Comparable<HogBugReport> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new HogBugReportStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new HogBugReportTupleSchemeFactory();

  public java.lang.String uuId; // required
  public java.util.List<HogsBugs> hbList; // optional
  ...
  public HogBugReport(HogBugReport other) {
    ...
    if (other.isSetHbList()) {
      java.util.List<HogsBugs> __this__hbList = new java.util.ArrayList<HogsBugs>(other.hbList.size());
      for (HogsBugs other_element : other.hbList) {
        __this__hbList.add(new HogsBugs(other_element));
      }
      this.hbList = __this__hbList;
    }
  }
  ...
  public HogBugReport setUuId(java.lang.String uuId) {
    this.uuId = uuId;
    return this;
  }
  ...
  public void addToHbList(HogsBugs elem) {
    if (this.hbList == null) {
      this.hbList = new java.util.ArrayList<HogsBugs>();
    }
    this.hbList.add(elem);
  }

  public java.util.List<HogsBugs> getHbList() {
    return this.hbList;
  }

  public HogBugReport setHbList(java.util.List<HogsBugs> hbList) {
    this.hbList = hbList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case HB_LIST:
      if (value == null) {
        ...
        setHbList((java.util.List<HogsBugs>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetHbList()) ? 131071 : 524287);
    if (isSetHbList())
      hashCode = hashCode * 8191 + hbList.hashCode();
  ...
  public int compareTo(HogBugReport other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHbList()).compareTo(other.isSetHbList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHbList()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("HogBugReport(");
    boolean first = true;
  ...
  private static class HogBugReportStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public HogBugReportStandardScheme getScheme() {
      return new HogBugReportStandardScheme();
    }
  }

  private static class HogBugReportStandardScheme extends org.apache.thrift.scheme.StandardScheme<HogBugReport> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hbList = new java.util.ArrayList<HogsBugs>(_list128.size);
                HogsBugs _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = new HogsBugs();
                  _elem129.read(iprot);
                  struct.hbList.add(_elem129);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.hbList != null) {
        if (struct.isSetHbList()) {
          oprot.writeFieldBegin(HB_LIST_FIELD_DESC);
          {
            ...
            for (HogsBugs _iter131 : struct.hbList)
            {
  ...
  private static class HogBugReportTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public HogBugReportTupleScheme getScheme() {
      return new HogBugReportTupleScheme();
    }
  }

  private static class HogBugReportTupleScheme extends org.apache.thrift.scheme.TupleScheme<HogBugReport> {
      ...
      if (struct.isSetHbList()) {
        {
          ...
          for (HogsBugs _iter132 : struct.hbList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.hbList = new java.util.ArrayList<HogsBugs>(_list133.size);
          HogsBugs _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new HogsBugs();
            _elem134.read(iprot);
            struct.hbList.add(_elem134);
          }
        }
        struct.setHbListIsSet(true);
      }
