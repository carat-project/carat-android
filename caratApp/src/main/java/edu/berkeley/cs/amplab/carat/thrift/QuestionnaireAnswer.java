            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.answers = new ArrayList<Integer>(_list96.size);
                int _elem97;
                for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                {
                  _elem97 = iprot.readI32();
                  struct.answers.add(_elem97);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.answers != null) {
        if (struct.isSetAnswers()) {
          oprot.writeFieldBegin(ANSWERS_FIELD_DESC);
          {
            ...
            for (int _iter99 : struct.answers)
            {
      ...
      if (struct.isSetAnswers()) {
        {
          ...
          for (int _iter100 : struct.answers)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.answers = new ArrayList<Integer>(_list101.size);
          int _elem102;
          for (int _i103 = 0; _i103 < _list101.size; ++_i103)
          {
            _elem102 = iprot.readI32();
            struct.answers.add(_elem102);
          }
        }
        struct.setAnswersIsSet(true);
      }
