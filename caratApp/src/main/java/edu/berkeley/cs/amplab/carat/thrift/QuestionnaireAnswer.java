...
public class QuestionnaireAnswer implements org.apache.thrift.TBase<QuestionnaireAnswer, QuestionnaireAnswer._Fields>, java.io.Serializable, Cloneable, Comparable<QuestionnaireAnswer> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new QuestionnaireAnswerStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new QuestionnaireAnswerTupleSchemeFactory();

  public int questionId; // required
  public java.util.List<java.lang.Integer> answers; // optional
  public java.lang.String input; // optional
  ...
  public QuestionnaireAnswer(QuestionnaireAnswer other) {
    ...
    if (other.isSetAnswers()) {
      java.util.List<java.lang.Integer> __this__answers = new java.util.ArrayList<java.lang.Integer>(other.answers);
  ...
  public java.util.Iterator<java.lang.Integer> getAnswersIterator() {
    return (this.answers == null) ? null : this.answers.iterator();
  }

  public void addToAnswers(int elem) {
    if (this.answers == null) {
      this.answers = new java.util.ArrayList<java.lang.Integer>();
    }
    this.answers.add(elem);
  }

  public java.util.List<java.lang.Integer> getAnswers() {
    return this.answers;
  }

  public QuestionnaireAnswer setAnswers(java.util.List<java.lang.Integer> answers) {
  ...
  public QuestionnaireAnswer setInput(java.lang.String input) {
    this.input = input;
    return this;
  }
  ...
  public void unsetOther() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __OTHER_ISSET_ID);
  }

  /** Returns true if field other is set (has been assigned a value) and false otherwise */
  public boolean isSetOther() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __OTHER_ISSET_ID);
  }

  public void setOtherIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __OTHER_ISSET_ID, value);
  }
  ...
  public QuestionnaireAnswer setLocation(java.lang.String location) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ANSWERS:
      if (value == null) {
        ...
        setAnswers((java.util.List<java.lang.Integer>)value);
      }
      break;
    ...
    case OTHER:
      if (value == null) {
        ...
        setOther((java.lang.Boolean)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((other) ? 131071 : 524287);
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("QuestionnaireAnswer(");
    boolean first = true;
  ...
  private static class QuestionnaireAnswerStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public QuestionnaireAnswerStandardScheme getScheme() {
      return new QuestionnaireAnswerStandardScheme();
    }
  }

  private static class QuestionnaireAnswerStandardScheme extends org.apache.thrift.scheme.StandardScheme<QuestionnaireAnswer> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.answers = new java.util.ArrayList<java.lang.Integer>(_list168.size);
                int _elem169;
  ...
  private static class QuestionnaireAnswerTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public QuestionnaireAnswerTupleScheme getScheme() {
      return new QuestionnaireAnswerTupleScheme();
    }
  }

  private static class QuestionnaireAnswerTupleScheme extends org.apache.thrift.scheme.TupleScheme<QuestionnaireAnswer> {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.answers = new java.util.ArrayList<java.lang.Integer>(_list173.size);
          int _elem174;
