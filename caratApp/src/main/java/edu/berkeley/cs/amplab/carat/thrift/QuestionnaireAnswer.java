            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.answers = new ArrayList<Integer>(_list120.size);
                int _elem121;
      ...
      if (struct.answers != null) {
        if (struct.isSetAnswers()) {
          oprot.writeFieldBegin(ANSWERS_FIELD_DESC);
          {
            ...
            for (int _iter123 : struct.answers)
            {
      ...
      if (struct.isSetAnswers()) {
        {
          ...
          for (int _iter124 : struct.answers)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.answers = new ArrayList<Integer>(_list125.size);
          int _elem126;
