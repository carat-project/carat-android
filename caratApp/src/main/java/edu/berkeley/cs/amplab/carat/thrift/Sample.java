...
public class Sample implements org.apache.thrift.TBase<Sample, Sample._Fields>, java.io.Serializable, Cloneable, Comparable<Sample> {
  ...
  public List<Long> thermalZones; // optional
  public List<String> thermalZoneNames; // optional
  ...
  public Sample(Sample other) {
    ...
    if (other.isSetThermalZones()) {
      List<Long> __this__thermalZones = new ArrayList<Long>(other.thermalZones);
      this.thermalZones = __this__thermalZones;
    }
    if (other.isSetThermalZoneNames()) {
      List<String> __this__thermalZoneNames = new ArrayList<String>(other.thermalZoneNames);
  ...
  public Sample setCountryCode(String countryCode) {
  ...
  public void unsetLightIdleEnabled() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LIGHTIDLEENABLED_ISSET_ID);
  }
  ...
  public boolean isSetLightIdleEnabled() {
    return EncodingUtils.testBit(__isset_bitfield, __LIGHTIDLEENABLED_ISSET_ID);
  }

  public void setLightIdleEnabledIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LIGHTIDLEENABLED_ISSET_ID, value);
  }
  ...
  public void unsetDeepIdleEnabled() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __DEEPIDLEENABLED_ISSET_ID);
  }
  ...
  public boolean isSetDeepIdleEnabled() {
    return EncodingUtils.testBit(__isset_bitfield, __DEEPIDLEENABLED_ISSET_ID);
  }

  public void setDeepIdleEnabledIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __DEEPIDLEENABLED_ISSET_ID, value);
  }
  ...
  public java.util.Iterator<Long> getThermalZonesIterator() {
  ...
  public void addToThermalZones(long elem) {
    if (this.thermalZones == null) {
      this.thermalZones = new ArrayList<Long>();
    }
  ...
  public Sample setThermalZones(List<Long> thermalZones) {
  ...
  public java.util.Iterator<String> getThermalZoneNamesIterator() {
    return (this.thermalZoneNames == null) ? null : this.thermalZoneNames.iterator();
  }

  public void addToThermalZoneNames(String elem) {
    if (this.thermalZoneNames == null) {
      this.thermalZoneNames = new ArrayList<String>();
    }
  ...
  public Sample setThermalZoneNames(List<String> thermalZoneNames) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LIGHT_IDLE_ENABLED:
      if (value == null) {
        ...
        setLightIdleEnabled((Boolean)value);
      }
      break;
    ...
    case DEEP_IDLE_ENABLED:
      if (value == null) {
        ...
        setDeepIdleEnabled((Boolean)value);
      }
      break;
    ...
    case THERMAL_ZONES:
      if (value == null) {
        ...
        setThermalZones((List<Long>)value);
      }
      break;
    ...
    case THERMAL_ZONE_NAMES:
      if (value == null) {
        ...
        setThermalZoneNames((List<String>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_storageDetails = true && (isSetStorageDetails());
    list.add(present_storageDetails);
    if (present_storageDetails)
      list.add(storageDetails);
    ...
    boolean present_lightIdleEnabled = true && (isSetLightIdleEnabled());
    list.add(present_lightIdleEnabled);
    if (present_lightIdleEnabled)
      list.add(lightIdleEnabled);

    boolean present_deepIdleEnabled = true && (isSetDeepIdleEnabled());
    list.add(present_deepIdleEnabled);
    if (present_deepIdleEnabled)
      list.add(deepIdleEnabled);

    boolean present_thermalZones = true && (isSetThermalZones());
    list.add(present_thermalZones);
    if (present_thermalZones)
      list.add(thermalZones);

    boolean present_thermalZoneNames = true && (isSetThermalZoneNames());
    list.add(present_thermalZoneNames);
    if (present_thermalZoneNames)
      list.add(thermalZoneNames);
  ...
  public int compareTo(Sample other) {
    ...
    lastComparison = Boolean.valueOf(isSetStorageDetails()).compareTo(other.isSetStorageDetails());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetLightIdleEnabled()).compareTo(other.isSetLightIdleEnabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetDeepIdleEnabled()).compareTo(other.isSetDeepIdleEnabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetThermalZones()).compareTo(other.isSetThermalZones());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetThermalZoneNames()).compareTo(other.isSetThermalZoneNames());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.piList = new ArrayList<ProcessInfo>(_list40.size);
                ProcessInfo _elem41;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.locationProviders = new ArrayList<String>(_list43.size);
                String _elem44;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.extra = new ArrayList<Feature>(_list46.size);
                Feature _elem47;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.thermalZones = new ArrayList<Long>(_list49.size);
                long _elem50;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.thermalZoneNames = new ArrayList<String>(_list52.size);
                String _elem53;
      ...
      if (struct.locationProviders != null) {
        if (struct.isSetLocationProviders()) {
          oprot.writeFieldBegin(LOCATION_PROVIDERS_FIELD_DESC);
          {
            ...
            for (String _iter56 : struct.locationProviders)
            {
      ...
      if (struct.thermalZoneNames != null) {
        if (struct.isSetThermalZoneNames()) {
          oprot.writeFieldBegin(THERMAL_ZONE_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter59 : struct.thermalZoneNames)
            {
      ...
      if (struct.isSetLocationProviders()) {
        {
          ...
          for (String _iter61 : struct.locationProviders)
          {
      ...
      if (struct.isSetThermalZoneNames()) {
        {
          ...
          for (String _iter64 : struct.thermalZoneNames)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.piList = new ArrayList<ProcessInfo>(_list65.size);
          ProcessInfo _elem66;
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.locationProviders = new ArrayList<String>(_list68.size);
          String _elem69;
      ...
      if (incoming.get(22)) {
        {
          ...
          struct.extra = new ArrayList<Feature>(_list71.size);
          Feature _elem72;
      ...
      if (incoming.get(29)) {
        {
          ...
          struct.thermalZones = new ArrayList<Long>(_list74.size);
          long _elem75;
      ...
      if (incoming.get(30)) {
        {
          ...
          struct.thermalZoneNames = new ArrayList<String>(_list77.size);
          String _elem78;
